...
* 
*/
class Cargarmate extends CI_Controller
{
	public function __construct() {
        parent::__construct(); 
        $this->load->library('form_validation'); 
        $this->load->helper("url"); 
        $this->load->model('preguntas/insertarmat_model');
    }
	...
	public function index()
	{
		...
		$this->insertarmat_model->insert($_POST['pregunta'],$_POST['respuestav'],$_POST['respuestaf1'],$_POST['respuestaf2'],$_POST['respuestaf3'],$_POST['respuestaf4'],$_POST['nota'],$_POST['oculto']);
		/*
