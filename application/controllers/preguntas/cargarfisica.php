...
* 
*/
class Cargarfisica extends CI_Controller
{
	public function __construct() {
        parent::__construct(); 
        $this->load->library('form_validation'); 
        $this->load->helper("url"); 
        $this->load->model('preguntas/insertarfis_model');  
    }
	...
	public function index()
	{
		...
		$this->insertarfis_model->insert($_POST['pregunta'],$_POST['respuestav'],$_POST['respuestaf1'],$_POST['respuestaf2'],$_POST['respuestaf3'],$_POST['respuestaf4'],$_POST['nota'],$_POST['oculto']);
		/*
